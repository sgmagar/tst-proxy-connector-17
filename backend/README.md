...
## Project Structure
    ...
    ├── tst_proxy_connector_17  # Django project configurations
...
1. Clone this repo and `cd tst_proxy_connector_17`
...
2. Clone this repo and `cd tst_proxy_connector_17`
